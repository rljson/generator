...
const filesToBeDeleted = [
  ...
  'doc/workflows/update-from-generator.md',
];

const templateRepo = 'https://github.com/rljson/generator.git';
const localRepoPath = path.resolve(__dirname, '../../generator');
...
function replaceGenerator() {
  ...
  for (const file of replaceFiles) {
    ...
    if (fs.existsSync(filePath)) {
      ...
      content = content.replace(/generator/g, projectName);
