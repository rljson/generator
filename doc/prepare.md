...
- [Open generator the first time](#open-generator-the-first-time)
  ...
  - [Open generator with Vscode](#open-generator-with-vscode)
...
```bash
git clone https://github.com/rljson/generator.git
```
